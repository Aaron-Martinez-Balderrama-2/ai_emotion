...
fn_requerir_permiso('ver_diccionario');
...
function fn_grilla_diccionario()
{
    ...
    <form method="POST" action="" id="frm_b">
        ...
        <div class="g_cabeza_busqueda">
            <div class="g_buscador_wrapper">
                ...
                <input type="text" name="b" value="<?= $buscar ?>" class="g_buscador" placeholder="Buscar palabra..." onsearch="if(this.value=='')this.form.submit();">
            </div>
            
            <a href="javascript:void(0)" onclick="id_n.value=''; tip.value='1'; frm_n.submit();" class="g_btn_nuevo">
                <i class="fas fa-plus-circle"></i> Nueva Palabra
            </a>
        </div>
    </form>
    ...
    <div class="g_grilla_colossus">
        <div class="g_cabeza">
            <h3><i class="fas fa-list"></i> Palabras de Entrenamiento</h3>
        </div>
